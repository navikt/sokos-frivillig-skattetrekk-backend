      ...
      <List>
        ...
        { sendResponse != null &&
            <VStack gap={{xs: "2", md: "6"}}>
                ...
                <RegistrerteSkattetrekk skatteTrekk={sendResponse!.skattetrekk} tilleggstrekk={sendResponse!.tilleggstrekk} framtidigTilleggstrekk={sendResponse!.framtidigTilleggstrekk} />
            </VStack> }
