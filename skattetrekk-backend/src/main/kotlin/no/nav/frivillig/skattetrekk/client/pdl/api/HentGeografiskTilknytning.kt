...
data class HentPdlGeografiskTilknytningResponse(val data: DataWrapperGeografiskTilknytning?, val errors: List<PdlError>? = null)
data class DataWrapperGeografiskTilknytning(val hentGeografiskTilknytning: GeografiskTilknytning?)
