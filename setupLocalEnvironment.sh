...
envValue=$(kubectl exec -it $(kubectl get pods | grep sokos-frivillig-skattetrekk-backend-q2 | cut -f1 -d' ') -c sokos-frivillig-skattetrekk-backend-q2 -- env | egrep "^AZURE|^TREKK|^TOKEN_X" | sort)
